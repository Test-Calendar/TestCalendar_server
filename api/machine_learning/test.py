...
def tests_process():
    ...
    tests.append(Test("poko", 1, 7, datetime.datetime(2017, 11, 10)))
    tests.append(Test("poko", 2, 7, datetime.datetime(2017, 11, 10)))
    tests.append(Test("taku", 2, 7, datetime.datetime(2017, 11, 12)))
